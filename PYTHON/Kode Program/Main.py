...
def main():
    ...
    pc_cpu = Cpu(16, True, 8, 3.5, "AMD Ryzen", 4500000)
    pc_gpu = Gpu(8, "RDNA", 3584, 1770.0, "AMD Radeon", 5500000)
    ...
    laptop_cpu = Cpu(8, True, 16, 4.0, "Apple M1", 7000000)
    laptop_gpu = Gpu(6, "Integrated", 2048, 1600.0, "Apple GPU", 4500000)
